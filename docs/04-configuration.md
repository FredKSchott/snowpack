...
| `installTypes`    | `boolean`  | `false`           | (`source: "pika"` only) Install web_modules/.types packages. Make sure that you've made the required changes to your [tsconfig.json](#TypeScript) to pick up these types.                              |
