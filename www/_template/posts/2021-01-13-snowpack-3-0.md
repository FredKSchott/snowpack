...
- **Pre-bundled Streaming imports** - Fetch pre-built npm dependencies on-demand.
...
Snowpack v3.0 marks another step forward on this mission to redefine modern web development with the release of **streaming imports**. Streaming imports are for a world where packages can be imported directly into your project, on-demand and only when needed.
