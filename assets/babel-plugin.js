...
function rewriteImport(importMap, imp, file, dir, shouldResolveRelative) {
...
module.exports = function pikaWebBabelTransform(
  {types: t, env},
  {resolve, dir, addVersion, importMap, optionalExtensions} = {},
) {
  // Default options
  ...
  return {
    ...
    visitor: {
      CallExpression(path, {file, opts}) {
        ...
        source.replaceWith(
          t.stringLiteral(
            rewriteImport(this.importMapJson, source.node.value, file, dir, shouldResolveRelative),
          ),
        );
      },
