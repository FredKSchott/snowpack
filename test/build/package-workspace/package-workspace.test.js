...
describe('test workspace linked packages', () => {
  ...
  it('builds source files as expected', () => {
    ...
    expect(fs.readFileSync(jsLoc, 'utf-8')).toContain(`../_snowpack/link/test-workspace-component/SvelteComponent.svelte.js`); // file has expected imports
    expect(fs.readFileSync(jsLoc, 'utf-8')).toContain(`../_snowpack/link/test-workspace-component/works-without-extension.js`); // file has expected imports
  });
