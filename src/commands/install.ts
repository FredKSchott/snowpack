...
import {EnvVarReplacements, SnowpackConfig, SnowpackFile} from '../config.js';
...
export async function getInstallTargets(config: SnowpackConfig, scannedFiles?: SnowpackFile[]) {
